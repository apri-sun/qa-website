...
{
    private static final String SOLR_URL = "http://127.0.0.1:8983/solr/core1";
    ...
    public List<Question> searchQuestion(String keyword, int offset, int count, String hlPre, String hlPos) throws Exception
    {
        ...
        SolrQuery query = new SolrQuery(getKeyword(keyword));
        query.setRows(count);
    ...
    @Override
    public boolean indexQuestion(Long questionId, String title, String content) throws Exception
    {
    ...
    private String getKeyword(String keyword)
    {
        ...
        sb.append(QUESTION_TITLE_FIELD + ":" + keyword);
        sb.append(" OR ");
        sb.append(QUESTION_CONTENT_FIELD+ ":" + keyword);
        return sb.toString();
    }
}
